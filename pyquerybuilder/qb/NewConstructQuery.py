...
class NewConstruct(object):
    """
    Query construct, run construct algorithm on Graph structure.
    Graph structure is undirected weighted graph

    """
    def __init__(self, graphs):
        """Initialization"""
        self._ugraphs = [ graph.get_undirected() for graph in graphs ]
